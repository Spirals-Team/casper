	...
	public static void main(String[] args) {
		try{
			...
			spooner.setProcessors(
					...
					"bcu.transformer.processors.FieldModifier",
					"bcu.transformer.processors.VariableModifier",
					"bcu.transformer.processors.AssignmentModifier",
					"bcu.transformer.processors.ArgumentsModifier",
					"bcu.transformer.processors.ReturnModifier",
					"bcu.transformer.processors.ComparizonModifier"

					
//					"bcu.spoonware.processor.AssignmentModifierLight",
//					"bcu.spoonware.processor.VariableModifierLight",
//					"bcu.spoonware.processor.BinaryOperatorModifierLight"
					);
